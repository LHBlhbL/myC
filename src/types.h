...
void initTexture(Texture* self,int duration,int  length,int frames);
void destroyTexture(Texture* self);

bool initText(Text* self,const char* str,SDL_Color color );
Text* creatText(const char* str,  SDL_Color color);
